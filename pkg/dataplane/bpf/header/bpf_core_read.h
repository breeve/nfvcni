...
#define bpf_core_read_user_str(dst, sz, src)                                   \
  bpf_probe_read_user_str(dst, sz,                                             \
                          (const void *)__builtin_preserve_access_index(src))
...
#define BPF_CORE_READ_USER_INTO(dst, src, a, ...)                              \
  ({___core_read(bpf_core_read_user, bpf_core_read_user, dst, (src), a,        \
                 ##__VA_ARGS__)})
...
#define BPF_PROBE_READ_USER_INTO(dst, src, a, ...)                             \
  ({___core_read(bpf_probe_read_user, bpf_probe_read_user, dst, (src), a,      \
                 ##__VA_ARGS__)})
...
#define BPF_CORE_READ_STR_INTO(dst, src, a, ...)                               \
  ({___core_read(bpf_core_read_str, bpf_core_read, dst, (src), a,              \
                 ##__VA_ARGS__)})
...
#define BPF_CORE_READ_USER_STR_INTO(dst, src, a, ...)                          \
  ({___core_read(bpf_core_read_user_str, bpf_core_read_user, dst, (src), a,    \
                 ##__VA_ARGS__)})

/* Non-CO-RE variant of BPF_CORE_READ_STR_INTO() */
#define BPF_PROBE_READ_STR_INTO(dst, src, a, ...)                              \
  ({___core_read(bpf_probe_read_kernel_str, bpf_probe_read_kernel, dst, (src), \
                 a, ##__VA_ARGS__)})
...
#define BPF_PROBE_READ_USER_STR_INTO(dst, src, a, ...)                         \
  ({___core_read(bpf_probe_read_user_str, bpf_probe_read_user, dst, (src), a,  \
                 ##__VA_ARGS__)})
