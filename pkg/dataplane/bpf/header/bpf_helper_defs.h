...
static long (*bpf_load_hdr_opt)(struct bpf_sock_ops *skops, void *searchby_res,
                                __u32 len, __u64 flags) = (void *)142;
...
static long (*bpf_store_hdr_opt)(struct bpf_sock_ops *skops, const void *from,
                                 __u32 len, __u64 flags) = (void *)143;
 ...
 * 	*skops*\ **->op**.
 */
static long (*bpf_reserve_hdr_opt)(struct bpf_sock_ops *skops, __u32 len,
                                   __u64 flags) = (void *)144;
 ...
 */
static void *(*bpf_inode_storage_get)(void *map, void *inode, void *value,
                                      __u64 flags) = (void *)145;
...
static long (*bpf_snprintf_btf)(char *str, __u32 str_size, struct btf_ptr *ptr,
                                __u32 btf_ptr_size, __u64 flags) = (void *)149;
...
static long (*bpf_seq_printf_btf)(struct seq_file *m, struct btf_ptr *ptr,
                                  __u32 ptr_size, __u64 flags) = (void *)150;
 ...
 */
static void *(*bpf_per_cpu_ptr)(const void *percpu_ptr,
                                __u32 cpu) = (void *)153;
...
static void *(*bpf_task_storage_get)(void *map, struct task_struct *task,
                                     void *value, __u64 flags) = (void *)156;
 ...
 * 	**-ENOENT** if the bpf_local_storage cannot be found.
 */
static long (*bpf_task_storage_delete)(void *map,
                                       struct task_struct *task) = (void *)157;
 ...
 */
static long (*bpf_bprm_opts_set)(struct linux_binprm *bprm,
                                 __u64 flags) = (void *)159;
 ...
 */
static long (*bpf_ima_inode_hash)(struct inode *inode, void *dst,
                                  __u32 size) = (void *)161;
...
static long (*bpf_check_mtu)(void *ctx, __u32 ifindex, __u32 *mtu_len,
                             __s32 len_diff, __u64 flags) = (void *)163;
...
static long (*bpf_snprintf)(char *str, __u32 str_size, const char *fmt,
                            __u64 *data, __u32 data_len) = (void *)165;
 ...
 * 	A syscall result.
 */
static long (*bpf_sys_bpf)(__u32 cmd, void *attr,
                           __u32 attr_size) = (void *)166;
 ...
 */
static long (*bpf_btf_find_by_name_kind)(char *name, int name_sz, __u32 kind,
                                         int flags) = (void *)167;
 ...
 */
static long (*bpf_timer_init)(struct bpf_timer *timer, void *map,
                              __u64 flags) = (void *)169;
 ...
 * 	closed all timers in the map will be cancelled and freed.
 */
static long (*bpf_timer_set_callback)(struct bpf_timer *timer,
                                      void *callback_fn) = (void *)170;
 ...
 */
static long (*bpf_timer_start)(struct bpf_timer *timer, __u64 nsecs,
                               __u64 flags) = (void *)171;
 ...
 * 	**-ENOENT** if architecture does not support branch records.
 */
static long (*bpf_get_branch_snapshot)(void *entries, __u32 size,
                                       __u64 flags) = (void *)176;
 ...
 */
static long (*bpf_kallsyms_lookup_name)(const char *name, int name_sz,
                                        int flags, __u64 *res) = (void *)179;
 ...
 */
static long (*bpf_find_vma)(struct task_struct *task, __u64 addr,
                            void *callback_fn, void *callback_ctx,
