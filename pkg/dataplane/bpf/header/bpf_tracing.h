...
#define BPF_PROG(name, args...)                                                \
  ...
  typeof(name(0)) name(unsigned long long *ctx) {                              \
    _Pragma("GCC diagnostic push") _Pragma(                                    \
        ...
        "\"-Wint-conversion\"") return ____##name(___bpf_ctx_cast(args));      \
...
#define BPF_KPROBE(name, args...)                                              \
  ...
  typeof(name(0)) name(struct pt_regs *ctx) {                                  \
    _Pragma("GCC diagnostic push") _Pragma(                                    \
        "GCC diagnostic ignored "                                              \
        "\"-Wint-conversion\"") return ____##name(___bpf_kprobe_args(args));   \
    _Pragma("GCC diagnostic pop")                                              \
  }                                                                            \
  static __attribute__((always_inline)) typeof(name(0)) ____##name(            \
      struct pt_regs *ctx, ##args)
...
#define BPF_KRETPROBE(name, args...)                                            \
  ...
  typeof(name(0)) name(struct pt_regs *ctx) {                                   \
    _Pragma("GCC diagnostic push") _Pragma(                                     \
        "GCC diagnostic ignored "                                               \
        "\"-Wint-conversion\"") return ____##name(___bpf_kretprobe_args(args)); \
    _Pragma("GCC diagnostic pop")                                               \
  }                                                                             \
